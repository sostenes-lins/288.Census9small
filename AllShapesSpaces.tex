...
\begin{proof}
 ...
 was partitioned by homology and WRT$_{12}$ into 487 classes, named 
...
Warning: the present work is completely independent of Fig. \ref{fig:reducedblinkcalculus} 
...
can be skipped at no logical cost. But we strongly recomend the reader not to do so,
because the results and the Conjecture are stated  
to situate our research in its appropriate context and timing.
...
What is needed to close by polynomial algorithms 
this chain of objects is to establish the following 
...
We stress that there will be many interesting and deep consequences 
...
\section{Universal set of blinks and the  resolution of the doubts}
\label{sec:resol}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=14cm]{A.figs/4pipeline.pdf}
   \end{center}
   \vspace{-0.7cm}
   \caption{Pipeline for the generation of the set $U_k=U_4$}
   \label{fig:4pipeline}
\end{figure}


\subsection{Topological filtering}
\begin{figure}[!h]
\begin{center}
\includegraphics[width=14cm] {A.figs/SomeTopologicalFiltering.pdf}
\caption{\sf Some topological filtering in the blink generation}
...
by yet to be found new invariants.
 ...
 break the $HG8QI$-class $16_{42}$ into two homeomorphic classes of two blinks each. 
