...
``The ultimate goal of the theory would be in providing solutions to:
 ...
 S. Lins, \cite{kauffman1994tlr}, they remain largely unkown. 
 ...
 No doubt that blinks are simple. But after Martelli's reformulation we see that they hold
 ...
 each closed orientable 3-manifold can be encoded by a link in $\mathbb{S}^ 3$ 
 ...
 we want to be contractible in the solid torus inside $\mathbb{M}^3$. For each component, we then
 identify the curve given by the pair with the meridian of a canonical copy of a 
 solid torus in $\mathbb{R}^ 3$  to as to completely specify the closing of each toroidal hole.
 
 
  \begin{proposition}
  Given any fractional framed link it is possible to obtain an integer framed link
  inducing the same 3-manifold.
 \end{proposition}
 \begin{proof}
  See \cite{rolfsen2003knots} for the proof and a simple complete example in \cite{lins1995gca}.
 \end{proof}
 
 A {\em blackboard framed link} is an integer framed link, given as a projection in the plane 
 (with upper and lower
 strands recorded) where the framing of a component the algebraic sum of the signs of 
 the self-crossings of the 
 component.
 ...
 \end{proposition}
 \begin{proof}
  Just introduce an adequate set of positive and negative curls to the components
...
\begin{theorem} Two blinks represent the same oriented closed 3-manifold if and only if
  ...
  $$\{\pm \rho_2, \pm \rho_2^\star, \pm \rho_3, \pm\alpha_{01}, \pm\alpha_{11},
  \pm\alpha_{12}, \pm\alpha_{21},  \pm\alpha_{31}, \pm\alpha_{41} \}
...
Any plane drawing whatsoever of a graph with an arbitrary bipartition of its edge set, a blink,
