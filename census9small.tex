...
The ribbon move and the Reidemeister moves are redundant in the calculus, since the configurations
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12cm]{A.figs/MartelliReformulationLinks.pdf} 
\caption{\sf Reformulation of moves $A_3$ and $A_4$ into $a_3$ and $a_4$}
\label{fig:MartelliReformulationLinks}
\end{center}
\end{figure}
