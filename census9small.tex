...
we we define and show how a {\em blink}, that is, a plane graph with
...
$U[1563]$ and $U[2165]$.
This is because the jgqi-classes $9_{126}$ and $9_{199}$ of \cite{lins2007blink} split
into two topological classes. The new content of the present work is to prove that the splitings indeed take place.
...
\cite{weeks2001snappea}
 ...
 \begin{figure}
\begin{center}
\includegraphics[width=8.0cm]{A.figs/nine126and199.pdf}
\caption{\sf {\bf Note's final challenge:}  classify topologically $9_{126}$ and $9_{199}$. 
Here, to classify has the following strict meaning: for each pair}
\label{fig:nine126and199}
\end{center}
\end{figure} 
