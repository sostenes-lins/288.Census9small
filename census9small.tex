...
\caption{\sf A blink-link-gem trio}
...
\end{figure} 
 ...
 Their isomorphism problem is computationally  simple.
 ...
 However, as a consequence of Martelli's reformulation of Kirby's calculus, we see that they hold,
...
\end{figure} 
 ...
 \begin{figure}[!h]
\begin{center}
\includegraphics[width=11cm]{A.figs/Martelli.pdf} 
\caption{\sf Martelli's finite set of 14 local moves, 
Reidemeister moves 2 and 3 and their inverse are not shown}
\label{fig:Martelli}
\end{center}
\end{figure} 
 ...
 identify the curve given by the pair with the meridian of a canonical copy of a 
